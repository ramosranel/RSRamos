...
<body>
    ...
    <div class="mainwrapper">
		<div class="maincontent">
			<h2 style="padding-top: 2em;padding-bottom: 2em;">Book Online</h2>
			<hr><br/><br/>

			<p>Fill-out the form below.</p><br><br>

			<form name="MyForm" action="book_action.php" onsubmit="return validateForm()" method="post">
				...
				<label for="adddress">Complete address</label>
